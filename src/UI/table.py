...
class Table(customtkinter.CTkScrollableFrame):
    def __init__(self, master, **kwargs):
        ...
        #             )
        #         self.table_row.grid(row=1, column=0, padx=0, pady=0, sticky="nsew")
...
class TableRow(customtkinter.CTkFrame):
    def __init__(self, master, checked: bool, code: str, desc: str, emb: str, price: str, local: str, status: str, **kwargs):
        super().__init__(master, **kwargs)
        ...
        self.checkbox.grid(row=4, column=0, padx=(2, 2), pady=(2, 2), sticky="nsew",)
        ...
        self.td_2.grid(row=4, column=1, padx=(2, 40), pady=(2, 2), sticky="nsew")
        ...
        self.td_3.grid(row=4, column=2, padx=(2, 180), pady=(2, 2), sticky="nsew")
        ...
        self.td_4.grid(row=4, column=3, padx=(2, 80), pady=(2, 2), sticky="nsew")
        ...
        self.td_5.grid(row=4, column=4, padx=(2, 50), pady=(2, 2), sticky="nsew")
        ...
        self.td_6.grid(row=4, column=5, padx=(2, 50), pady=(2, 2), sticky="nsew")
        ...
        self.td_7.grid(row=4, column=6, padx=(2, 50), pady=(2, 2), sticky="nsew")
